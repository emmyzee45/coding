...
// next and random pointer of the new nodes should point to new nodes in the copied list such that the 
// pointers in the original list and copied list represent the same list state. None of the pointers in 
...
// random_idex: the index of the node (range from 0 to n-1) that the random pointer points to, or null if it 
